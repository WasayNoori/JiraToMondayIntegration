...
///this service just reads the container and gets the Item ID IF one exist for an issue.
namespace JIRAToModayAPI.Storage
{
    public class JiraMondayMappingService
    {
        ...
        public JiraMondayMappingService(string connectionString, string containerName, string blobName)
        {
