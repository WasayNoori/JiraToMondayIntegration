...
namespace JIRAToModayAPI.Models
{
    ...
    public class JiraDescription
    {
        ...
        [JsonPropertyName("content")]
        public List<JiraDescriptionContent> Content { get; set; } = new List<JiraDescriptionContent>();
    }
    ...
    public class JiraDescriptionContent
    {
        ...
        [JsonPropertyName("content")]
        public List<JiraDescriptionText> Content { get; set; } = new List<JiraDescriptionText>();
    }

    public class JiraDescriptionText
    {
        [JsonPropertyName("type")]
        public string Type { get; set; } = string.Empty;
